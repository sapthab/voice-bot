...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.variable} ${geistSans.variable} ${waldenburgNormal.variable} ${waldenburgBuch.variable} ${waldenburgFett.variable} ${waldenburgFettHalbschmal.variable} antialiased`}
      >
        {children}
        <Toaster />
      </body>
